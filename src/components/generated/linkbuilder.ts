...
interface TargetTypes {
	tweets_tweets: "id" | "avatar" | "date" | "displayName" | "image" | "text" | "username" | "verified" | "_join";
	tweets_TweetsCountAggregateOutputType:
		| "id"
		| "avatar"
		| "date"
		| "displayName"
	...
	tweets_TweetsGroupByOutputType:
		...
		| "_max"
		| "_join";
	tweets_AffectedRowsOutput: "count" | "_join";
}

interface SourceFields {
	tweets_findFirsttweets: {
		where: null;
		orderBy: null;
		cursor: null;
		take: null;
